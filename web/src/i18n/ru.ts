...
export const ru = {
  ...
  'chat.ultracode_hint': 'Макс. effort + развёртка суб-агентов: агент декомпозирует задачу, гоняет параллельных суб-агентов и адверсариально проверяет находки перед действием. Медленнее и дороже — для серьёзной работы.',
