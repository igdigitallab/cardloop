...
export const ru = {
  ...
  'chat.autorotate_hint': 'Контроль стоимости: автоматически сворачивает сессию с handoff при превышении 280K токенов. Включено по умолчанию — выключай, только если чату нужен весь контекст.',
