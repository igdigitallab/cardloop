...
export const ru = {
  ...
  'chat.goal_label': 'Цель сессии',
  'chat.goal_hint': 'Закрепите цель для этого чата: нативный Stop-хук не даёт агенту остановиться — каждый ход завершается только когда оценщик подтвердит выполнение условия по транскрипту. Снимается автоматически при достижении.',
  'chat.goal_placeholder': 'Условие цели (напр. «все тесты зелёные и фикс задеплоен»)…',
  'chat.goal_save': 'Установить цель (Enter)',
  'chat.goal_cancel': 'Отмена (Esc)',
  'chat.goal_clear': 'Снять цель',
  'chat.goal_active': 'stop-hook',
  'chat.goal_met': 'достигнута ✓',
  'chat.goal_capped': 'лимит попыток',
  'chat.goal_iteration': 'не выполнено · попытка {n}',
