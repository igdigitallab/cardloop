...
export const ru = {
  ...
  'sidebar.search_placeholder': 'Поиск: проекты, чаты, файлы…',
  ...
  'chat.duplicate_dropped': 'Не отправлено: точно такой же текст уже выполняется или стоит в очереди. Измени его хоть немного, чтобы отправить.',

  // ── Message queue ──────────────────────────────────────────────
  'chat.queued_badge': 'в очереди',
  'chat.queued_badge_title': 'Ждёт в очереди — уйдёт автоматически, когда агент освободится',
  ...
  'agents.loading': 'Загрузка ролей агентов…',
  'agents.unavailable': 'Роли агентов пока недоступны в этой сборке.',
  'agents.retry': 'Повторить',
  'agents.main_title': 'Главный агент',
  'agents.main_hint': 'CLAUDE.md проекта остаётся основным документом — этот промпт добавляется к нему и подставляется в каждый ход основной сессии.',
  'agents.main_empty': 'Инструкций уровня проекта пока нет.',
  'agents.main_edit_btn': 'Редактировать',
  'agents.main_edit_aria': 'Редактировать инструкции главного агента',
  'agents.main_inherited': 'Унаследовано из глобального значения по умолчанию — сохранение здесь создаст переопределение на уровне проекта.',
  'agents.roles_title': 'Роли суб-агентов',
  'agents.roles_empty': 'Файлы ролей не найдены — используется встроенный набор (executor / researcher / skeptic / quick) как есть.',
  'agents.new_btn': '+ Новая роль',
  'agents.new_btn_aria': 'Создать новую роль',
  'agents.new_name_label': 'Имя роли (строчные буквы, цифры, дефис):',
  'agents.new_name_placeholder': 'reviewer-perf',
  'agents.name_reserved': '"main" зарезервировано для главного агента — используйте блок выше.',
  'agents.name_invalid': 'a-z / 0-9 / дефис, 2-32 символа, начинается с буквы или цифры.',
  'agents.new_scope_label': 'Область:',
  'agents.scope_global_warning': 'Эта роль будет доступна во всех проектах кокпита.',
  'agents.content_label': 'Файл роли (YAML frontmatter + тело промпта):',
  'agents.save_btn': 'Сохранить',
  'agents.saving': 'Сохраняю…',
  'agents.view_title': 'Просмотр роли',
  'agents.view_btn_aria': 'Просмотр роли (только чтение, встроенная)',
  'agents.edit_title': 'Редактирование роли',
  'agents.edit_btn_aria': 'Редактировать роль',
  'agents.delete_btn_aria': 'Удалить роль',
  'agents.copy_btn': 'Скопировать в проект',
  'agents.copy_btn_aria': 'Скопировать эту роль в область проекта',
  'agents.confirm_delete_title': 'Удалить роль?',
  'agents.confirm_delete_body': 'Файл роли будет удалён без возможности восстановления.',
  'agents.confirm_delete_global_body': 'Эта роль общая для всех проектов кокпита. Удаление уберёт её везде, файл не отслеживается в git — действие необратимо.',
  'agents.confirm_delete_yes': 'Да, удалить',
  'agents.builtin_note': 'Встроенные роли поставляются с Cardloop и доступны только для чтения — скопируйте в проект, чтобы изменить.',
  'agents.shadowed_by': 'перекрыта на уровне',
  'agents.confirm_global_toggle_title': 'Изменить для всех проектов?',
  'agents.confirm_overwrite_title': 'Заменить существующий файл роли?',
  'agents.confirm_overwrite_body': 'Файл роли уже существует по пути {file}. Сохранение заменит его текущее содержимое. Это действие необратимо.',
  'agents.confirm_overwrite_yes': 'Да, заменить',
  'agents.scope_builtin': 'встроенная',
  'agents.scope_global': 'глобальная',
  'agents.scope_project': 'проектная',
  'agents.errors_title': 'Ошибки разбора',
  'agents.enabled_aria': 'Роль включена',
  'agents.tools_all': 'все инструменты',
  'agents.tools_none': 'без инструментов',
  'agents.tools_suffix': 'инструментов',
  'agents.model_none': '—',
  ...
  // ── Ask mode (spec-082 A) ────────────────────────────────────────
  'chat.ask_label': 'Спрашивать меня',
  'chat.ask_toggle': 'Спрашивать перед каждым инструментом',
  'chat.ask_hint': 'Агент спрашивает, прежде чем что-то изменить: запись, правка или команда с последствиями вешает здесь карточку Разрешить / Всегда разрешать / Запретить и шлёт пуш на телефон. Чтение, поиск и команды, которые CLI считает безобидными, идут свободно. Без ответа запрос автоматически отклоняется через 15 минут. По умолчанию выключено; запоминается на чат.',
  'chat.ask_plan_conflict': 'Спрашивать меня подавлено, пока включён режим плана (план-ход и так read-only и уже под гейтом).',
  'chat.ask_codex_conflict': 'Спрашивать меня — гейт только для Claude, а этот чат на Codex.',
  'chat.ask_card_title': 'ждёт вашего решения',
  'chat.ask_allow': 'Разрешить',
  'chat.ask_allow_always': 'Всегда разрешать здесь',
  'chat.ask_deny': 'Запретить…',
  'chat.ask_deny_send': 'Отправить причину и запретить',
  'chat.ask_deny_cancel': 'Назад',
  'chat.ask_feedback_placeholder': 'Почему нет? (уйдёт модели, чтобы она подстроилась)',


  // ── Auto-rotate toggle (spec-059 / T3) ──────────────────────────
  'chat.autorotate_label': 'Авто-ротация',
  'chat.autorotate_toggle': 'Авто-ротация при 280K',
  'chat.autorotate_hint': 'Контроль стоимости: автоматически сворачивает сессию с handoff при превышении 280K токенов. Выключено по умолчанию — включай в проектах, где нужно ограничить расход. Настройка запоминается по проекту.',
  ...
  'notify.sound_label': 'Звук завершения',
  'notify.sound_hint': 'Сигнал в этом браузере, когда ход завершён и агент ждёт ответа — независимо от того, открыта вкладка или нет. Выбор звука сразу его проигрывает.',
  'notify.sound_test': 'Проверить',
  'notify.sound_volume': 'Громкость звука',
  'notify.sound_volume_hint': 'Уровень сигнала поверх громкости устройства. 100% — предел, громче браузер не сыграет без искажений.',
  ...
  'search.in_projects': 'Проекты',
  'search.in_everything': 'В чатах, файлах и досках',
