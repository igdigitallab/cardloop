...
export const en = {
  ...
  'sidebar.search_placeholder': 'Search projects, chats, files…',
  ...
  'chat.rewind_title': 'Rewind files to before this message',
  'chat.rewind_confirm': 'Restore all files touched by the agent to their state BEFORE this message? Chat history is kept; only files are rewound.',
  'chat.rewind_done': 'Files rewound',
  ...
  'agents.copy_btn': 'Copy to project',
  'agents.copy_btn_aria': 'Copy this role into the project scope',
  'agents.confirm_delete_title': 'Delete role?',
  ...
  'agents.confirm_global_toggle_title': 'Change this for every project?',
  // FX4/N5 + I1k: the backend now 409s a write that would replace an existing file; this
  // confirm is what "+ New role" and "Copy to project" show on that 409, naming the exact
  // file, instead of the stale client-side `data.roles` snapshot the previous round relied on.
  'agents.confirm_overwrite_title': 'Replace existing role file?',
  'agents.confirm_overwrite_body': 'A role file already exists at {file}. Saving now will replace its current content. This cannot be undone.',
  'agents.confirm_overwrite_yes': 'Yes, replace',
  'agents.scope_builtin': 'builtin',
  'agents.scope_global': 'global',
  'agents.scope_project': 'project',
  'agents.errors_title': 'Parse errors',
  'agents.enabled_aria': 'Role enabled',
  'agents.tools_all': 'all tools',
  'agents.tools_none': 'no tools',
  ...
  'chat.model_stale': '⚠ Stale model: {requested} ran {served}, newest is {expected}',
  ...
  'chat.autorotate_hint': 'Caps cost: auto-compacts the session with a handoff once it passes 280K tokens. Off by default — enable it per project when you want to bound spend. The choice is remembered per project.',
  ...
  'search.in_projects': 'Projects',
  'search.in_everything': 'In chats, files and boards',
