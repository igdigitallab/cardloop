  ...
  return (
    <div style={{ maxWidth: 660, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 28, padding: '6px 4px 32px' }}>
      ...
      <section>
        ...
        <Row title="Error notifications" hint="Notify in the cockpit on new incidents in Failed.">
        ...
        <Row title="After rate-limit"
          ...
          <select value={proj.auto_resume_mode}
                  onChange={ev => setProj({ ...proj, auto_resume_mode: ev.target.value as ProjectSettings['auto_resume_mode'] })}
                  aria-label="After rate-limit">
