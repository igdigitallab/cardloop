...
## Backlog
- [ ] Хранение ключей: продумать и реализовать хранилище credentials — проектные ключи (API keys, tokens сервисов) + глобальные ключи; UI в кокпите для просмотра/добавления; безопасное хранение (шифрование или vault); доступ агенту при выполнении задач <!--ops:a7b2c1-->
