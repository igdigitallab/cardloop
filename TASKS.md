...
- [ ] Агент в чате может запускать субагентов/агентов других т.е. оркестрировать работу. Что я часто и делаю. Но не совсем пон <!--ops:847153-->
  > ятно, что делает главный или агент. Нужно как то подсвечивать и/или вообще добавить возможность видеть что делает другой агент внутри сессии. Тоже додумать идею и реализовать.
