...
## Backlog
- [ ] У меня уже есть возможность двигать проекты в списке меню, но почему-то через планшет это не получается. <!--ops:f78394-->
...
- [ ] Кнопочка выделения в бклок очень стрёмно стоит. Нужно немножко сокращать пространство.. <!--ops:5eea57-->
