...
- **TabId актуальные:** `claude-md | logs | board | files | memory | timeline | settings` (7 вкладок; `secrets` — теперь секция в «Настройках», не вкладка; `overview` — перенесён в «Настройки»→«Project info»; «Лента»→«Активность» — Spec 011 Ф2).
...
- **TabId актуальные:** `claude-md | logs | board | files | memory | timeline | settings` (7 вкладок; `secrets` — секция в «Настройках», не вкладка; `overview` — перенесён в «Настройки»→«Project info» — Spec 011 Ф2).
