...
|---|---|---|
| Проекты | `api_projects`, `api_new_project`, `api_rename`, `api_health`, `api_git_sync` | |
...
- `data/topics.json` (СЛОЙ 1, вечный) · `data/sessions.json` (СЛОЙ 2, /reset чистит) · `data/prompts.json` · `data/runs/<card>.md` (сайдкары) · `data/audit/` · `data/inbox/` (файлы из TG) · `data/timeline/<slug>.jsonl` (Timeline Spec 008). **`data/` в .gitignore.**
