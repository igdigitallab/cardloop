...
# NOTE: the binding_for() reverse-lookup tests were removed with the Telegram
# adapter (spec-040). The slug-migration logic itself is covered by TestMigration above.
