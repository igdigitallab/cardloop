...
def _build_ctx(ptb_app, *, web_port: int = None, web_password: str = None,
               group_chat_id: int = None) -> dict:
    ...
    web_port, web_password, group_chat_id: TG-specific values passed in from bot.py
    ...
    _group_chat_id = group_chat_id if group_chat_id is not None else int(os.getenv("GROUP_CHAT_ID", "0"))
