...
- **Статус фаз:** F0 ✅ · F1 (авто-запуск) ✅ · C1 (чат SSE) ✅ · проводник ✅ · ресайз+сессии ✅. Дальше по roadmap: O1 Timeline, C2 гейт Применить/Отмена, автономный контур (сканеры/доктор/self-heal).
