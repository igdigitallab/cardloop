...
To put this on PATH (run once):
    ln -s /path/to/cardloop/secret.py ~/.local/bin/secret
    chmod +x ~/.local/bin/secret
Or add an alias in ~/.bashrc:
    alias secret='python /path/to/cardloop/secret.py'
...
def main() -> int:
    parser = argparse.ArgumentParser(
        prog="secret",
        description="Built-in encrypted secret store for Cardloop.",
    )
